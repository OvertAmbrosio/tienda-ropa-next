    ...
    <main className="grid min-h-screen grid-cols-1 md:grid-cols-2">
      <section className="relative hidden md:block">
        ...
        <div className="absolute bottom-8 left-8 right-8 text-white drop-shadow-lg">
          <h1 className="text-3xl font-semibold">Panel Administrativo • RUSARFI</h1>
          <p className="mt-2 max-w-md text-white/90">
            Accede al panel para gestionar tu tienda de ropa.
          </p>
        </div>
      </section>
        ...
        <div className="w-full max-w-md">
          <div className="mb-8 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Acceso al panel administrativo</p>
            </div>
          </div>
