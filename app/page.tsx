      ...
      <div className="fixed right-6 top-6 z-50 flex items-center gap-3">
        ...
        >
          <svg
            ...
            className="h-5 w-5"
          >
            <path d="M2.25 2.25a.75.75 0 0 0 0 1.5h1.386c.17 0 .318.114.362.278l.383 1.437 1.53 5.736a2.25 2.25 0 0 0 2.177 1.699h7.51a2.25 2.25 0 0 0 2.16-1.62l1.362-4.546A1.125 1.125 0 0 0 19.066 5.25H6.553l-.28-1.05A1.875 1.875 0 0 0 3.636 2.25H2.25z" />
            <path d="M8.25 21a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm9-1.5a1.5 1.5 0 1 1-3.001 0 1.5 1.5 0 0 1 3 0z" />
          </svg>
          <span className="text-sm">Carrito</span>
          <span className="ml-1 inline-flex min-w-[1.5rem] items-center justify-center rounded-full bg-emerald-600 px-2 text-xs font-medium text-white">
            {cartCount}
          </span>
        </button>
      </div>
